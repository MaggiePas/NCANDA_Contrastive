...
class CenterModel(LightningModule):
    ...
    def __init__(self, class_weight, scaler):
        ...
        self.fc2 = nn.Linear(self.NUM_FEATURES, 64)
        
        # Shared Layer
        self.fc3 = nn.Linear(64, 64)

        # first fc layer which takes concatenated imput
        self.fc4 = nn.Linear((64 + 64), 32)
        
        # final fc layer which takes concatenated imput
        self.fc5 = nn.Linear(32, 1)
        
        self.center_loss = CenterLoss(num_classes=2, feat_dim=32, use_gpu=True)
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = 1.0*bce_loss_f + 0.03*center_loss_f
    ...
    def validation_step(self, batch, batch_idx):
        ...
        loss = 1.0*bce_loss_f + 0.01*center_loss_f
    ...
    def training_epoch_end(self, outs):
        ...
        filename_out = '/home/users/paschali/results/train_out_center_' + str(self.current_epoch) + '_' + TARGET + '_' + self.trainer.logger.experiment.name + '.csv'
    ...
    def validation_epoch_end(self, outputs):
        ...
        filename_out = '/home/users/paschali/results/val_out_center_' + str(self.current_epoch) + '_' + TARGET + '_' + self.trainer.logger.experiment.name + '.csv'

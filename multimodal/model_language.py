...
class MultiModModelWithLanguage(LightningModule):
    ...
    def get_batch_sentences(self, tabular_to_encode):
        ...
        batch_highrisk_yss_extern = tabular_to_encode[:, 12] # not using currently
        batch_highrisk_yss_intern = tabular_to_encode[:, 13] # not using currently
        batch_highrisk_pss_extern = tabular_to_encode[:, 14] # not using currently
        batch_highrisk_pss_intern = tabular_to_encode[:, 15] # not using currently
